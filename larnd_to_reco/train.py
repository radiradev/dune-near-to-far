...
train_loader = DataLoader(train_dataset, batch_size=128, shuffle=True, collate_fn=batch_sparse_collate, num_workers=12, pin_memory=True, drop_last=True)
val_dataloader = DataLoader(val_dataset, batch_size=128, shuffle=True, collate_fn=batch_sparse_collate, drop_last=True)

model = LarndSimWrapper(model_task='regression', num_outputs=len(targets))
